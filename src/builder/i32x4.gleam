...
pub fn dot_i8x16_s(func: ExpressionBuilder) {
  todo
}
...
pub fn extadd_pairwise_i16x8_s(func: ExpressionBuilder) {
  todo
}

pub fn extadd_pairwise_i16x8_u(func: ExpressionBuilder) {
  todo
}

pub fn extend_high_i16x8_s(func: ExpressionBuilder) {
  todo
}

pub fn extend_high_i16x8_u(func: ExpressionBuilder) {
  todo
}

pub fn extend_low_i16x8_s(func: ExpressionBuilder) {
  todo
}

pub fn extend_low_i16x8_u(func: ExpressionBuilder) {
  todo
}

pub fn extmul_high_i16x8_s(func: ExpressionBuilder) {
  todo
}

pub fn extmul_high_i16x8_u(func: ExpressionBuilder) {
  todo
}

pub fn extmul_low_i16x8_s(func: ExpressionBuilder) {
  todo
}

pub fn extmul_low_i16x8_u(func: ExpressionBuilder) {
  todo
}
...
pub fn trunc_sat_f32x4_s(func: ExpressionBuilder) {
  todo
}

pub fn trunc_sat_f32x4_u(func: ExpressionBuilder) {
  todo
}

pub fn trunc_sat_f64x2_s_zero(func: ExpressionBuilder) {
  todo
}

pub fn trunc_sat_f64x2_u_zero(func: ExpressionBuilder) {
  todo
}
